...
|    Twin Type    |    Gender      |  
|:---------------:|:--------------:|  
|Identical (1/300)| boy-boy (1/2)  |  
|                 | girl-girl (1/2)|  
|Fraternal (1/125)| girl-girl (1/4)|  
|                 |  boy-boy (1/4) |  
|                 | boy-girl (2/4) |  

> Prob(ident|boy-boy) = Prob(ident and boy-boy)/Prob(boy-boy)  
> Prob(ident|boy-boy) = (1/300)(1/2)  /  (  (1/300)(1/2) + (1/125)(1/4) )  
> Prob = 5/11
...
- In the definition for probability:
> For frequentists, it's fundamentally related to frequencies of repeated events.
> For Bayesianists, it's fundamentally related to our own certainty /uncertainty of events (a measure of uncertainty)

- In the analysis of data:
> frequentists analyze _variation of data & derived quantities_ in light of _fixed model parameters_
> Bayesianists analyze _variation of beliefs_ about parameters in light of _fixed observed data_

source: Jake Vanderplas [Talk at Scipy2014](https://www.youtube.com/watch?v=KhAUfqhLakw) and [blog](http://jakevdp.github.io/blog/2014/03/11/frequentism-and-bayesianism-a-practical-intro/)
